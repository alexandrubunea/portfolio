function Hero() {
    return (
        <section className="flex justify-center min-h-screen px-6 sm:px-20 xl:px-0 overflow-hidden">
            <div className="glass-card bg-zinc-50/60 mt-10 w-full max-w-7xl h-[80vh] p-8 sm:p-12 lg:p-20">
                <div className="h-full flex flex-col justify-center space-y-8 items-center md:items-start">
                    ...
                    <div className="pt-8">
                        <button className="shiny-black-glass-button bg-zinc-900/80 px-8 py-4 rounded-full poppins-bold text-lg hover:cursor-pointer">
                            View My Work
                        </button>
                    </div>
                </div>
