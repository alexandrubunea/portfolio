function Hero() {
    return (
        <section className="flex justify-center min-h-screen px-6 sm:px-20 xl:px-0 overflow-hidden">
            <div className="glass-card mt-12 sm:mt-20 w-full max-w-7xl h-[80vh] p-8 sm:p-12 lg:p-20">
                <div className="h-full flex flex-col justify-center space-y-8">
                    ...
                    <blockquote className="text-lg text-zinc-600 max-w-3xl leading-relaxed poppins-regular-italic">
